...
public class Firetruck {
    ...
    public ArrayList<Admin> getCrew() {
        return crew;
    }
    ...
    public void setStatus(TruckStatus s) {
        this.status = s;
    }

    public void setResource(Resource r, int amount) {
        resources.put(r, amount);
    }

    public void addCrewMember(Admin a) {
        crew.add(a);
    }

...
public class DispatchPriorityRules {
    ...
    public void setVictimWeight(double w) {
        this.victimWeight = w;
    }

    public void setAreaWeight(double w) {
        this.areaWeight = w;
    }

    public void setIntensityWeight(double w) {
        this.intensityWeight = w;
    }
